...
//	systemChat format["StatusBar Initialized", _rscLayer];
		...
		switch(_minutes) do
	{
		...
		((uiNamespace getVariable "osefStatusBarAdmin")displayCtrl 55554)ctrlSetStructuredText parseText 
			...
			<t shadow='1' shadowColor='#000000' color='%15'><img size='1.0'  shadowColor='#000000' image='custom\statusbar\icons\compass.paa' color='%10'/> %17</t> 
			<t shadow='1' shadowColor='#000000' color='%10'><img size='1.6'  shadowColor='#000000' image='custom\statusbar\icons\restart.paa' color='%10'/>%18:%19</t>",
